...
namespace Collision
{
	...
	sf::Vector2f GetCircleCenter (const sf::CircleShape& Object)
	{
		sf::FloatRect AABB = Object.getGlobalBounds();
		return sf::Vector2f (AABB.left+AABB.width/2.f, AABB.top+AABB.height/2.f);
	}
	sf::Vector2f GetCircleSize (const sf::CircleShape& Object)
	{
		sf::FloatRect AABB = Object.getGlobalBounds();
		return sf::Vector2f (AABB.width, AABB.height);
	}
	bool CircleTestShape(const sf::CircleShape& Object1, const sf::CircleShape& Object2) {
		sf::Vector2f Obj1Size = GetCircleSize(Object1);
		sf::Vector2f Obj2Size = GetCircleSize(Object2);
		float Radius1 = (Obj1Size.x + Obj1Size.y) / 4;
		float Radius2 = (Obj2Size.x + Obj2Size.y) / 4;

		sf::Vector2f Distance = GetCircleCenter(Object1)-GetCircleCenter(Object2);
	...
	bool PointColllision(const sf::Shape& Object1, const sf::Vector2f& point){
		if(Object1.getGlobalBounds().contains(point)){
